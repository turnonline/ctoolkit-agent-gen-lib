...
public class Agent extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://c-toolkit.appspot.com/_ah/api/";
  ...
  public class Audit {
    ...
    public class List extends AgentRequest<org.ctoolkit.api.agent.model.MetadataAuditCollection> {
     ...
     [
      ...
      public List setAscending(java.lang.Boolean ascending) {
     ...
     [
      ...
      public List setOwnerId(java.lang.String ownerId) {
  ...
  /**
   * An accessor for creating requests from the ChangeBatch collection.
   *
   * <p>The typical use is:</p>
   * <pre>
   *   {@code Agent agent = new Agent(...);}
   *   {@code Agent.ChangeBatch.List request = agent.changeBatch().list(parameters ...)}
   * </pre>
   *
   * @return the resource collection
   */
  ...
  /**
   * The "changeBatch" collection of methods.
   */
  public class ChangeBatch {

    /**
     * Create a request for the method "changeBatch.delete".
     *
     * This request holds the parameters needed by the agent server.  After setting any optional
    ...
    public class Delete extends AgentRequest<Void> {
      ...
      private static final String REST_PATH = "change/{id}";
    ...
    /**
     * Create a request for the method "changeBatch.get".
     *
     * This request holds the parameters needed by the agent server.  After setting any optional
    ...
    public class Get extends AgentRequest<org.ctoolkit.api.agent.model.ChangeBatch> {
      ...
      protected Get(java.lang.String id) {
        super(Agent.this, "GET", REST_PATH, null, org.ctoolkit.api.agent.model.ChangeBatch.class);
        this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
      }
    ...
    /**
     * Create a request for the method "changeBatch.insert".
     *
     * This request holds the parameters needed by the agent server.  After setting any optional
     * parameters, call the {@link Insert#execute()} method to invoke the remote operation.
     *
     * @param content the {@link org.ctoolkit.api.agent.model.ChangeBatch}
     * @return the request
     */
    public Insert insert(org.ctoolkit.api.agent.model.ChangeBatch content) throws java.io.IOException {
      Insert result = new Insert(content);
      initialize(result);
      return result;
    }

    public class Insert extends AgentRequest<org.ctoolkit.api.agent.model.ChangeBatch> {
       ...
       * @since 1.13
       */
      protected Insert(org.ctoolkit.api.agent.model.ChangeBatch content) {
        super(Agent.this, "POST", REST_PATH, content, org.ctoolkit.api.agent.model.ChangeBatch.class);
      }
    ...
    /**
     * Create a request for the method "changeBatch.list".
     *
     * This request holds the parameters needed by the agent server.  After setting any optional
     * parameters, call the {@link List#execute()} method to invoke the remote operation.
     *
    ...
    public class List extends AgentRequest<org.ctoolkit.api.agent.model.ChangeBatchCollection> {
       ...
       */
      protected List() {
        super(Agent.this, "GET", REST_PATH, null, org.ctoolkit.api.agent.model.ChangeBatchCollection.class);
      }
    ...
    /**
     * Create a request for the method "changeBatch.update".
     *
     * This request holds the parameters needed by the agent server.  After setting any optional
     ...
     * @return the request
     */
    public Update update(java.lang.String id, org.ctoolkit.api.agent.model.ChangeBatch content) throws java.io.IOException {
      Update result = new Update(id, content);
      initialize(result);
      return result;
    }

    public class Update extends AgentRequest<org.ctoolkit.api.agent.model.ChangeBatch> {
       ...
       * @since 1.13
       */
      protected Update(java.lang.String id, org.ctoolkit.api.agent.model.ChangeBatch content) {
        super(Agent.this, "PUT", REST_PATH, content, org.ctoolkit.api.agent.model.ChangeBatch.class);
        this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
      }
    ...
    public class Item {
       ...
       * @return the request
       */
      public Delete delete(java.lang.String metadataId, java.lang.String id) throws java.io.IOException {
      ...
      public class Delete extends AgentRequest<Void> {
        ...
        private static final String REST_PATH = "change/{metadataId}/item/{id}";
         ...
         * @since 1.13
         */
        protected Delete(java.lang.String metadataId, java.lang.String id) {
          super(Agent.this, "DELETE", REST_PATH, null, Void.class);
        ...
        public Delete setMetadataId(java.lang.String metadataId) {
       ...
       * @return the request
       */
      public Get get(java.lang.String metadataId, java.lang.String id) throws java.io.IOException {
        Get result = new Get(metadataId, id);
        initialize(result);
        return result;
      }

      public class Get extends AgentRequest<org.ctoolkit.api.agent.model.ChangeItem> {
         ...
         * @since 1.13
         */
        protected Get(java.lang.String metadataId, java.lang.String id) {
          super(Agent.this, "GET", REST_PATH, null, org.ctoolkit.api.agent.model.ChangeItem.class);
          this.metadataId = com.google.api.client.util.Preconditions.checkNotNull(metadataId, "Required parameter metadataId must be specified.");
          this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
        }
        ...
        public Get setMetadataId(java.lang.String metadataId) {
          this.metadataId = metadataId;
          return this;
        }
       ...
       *
       * @param metadataId
       * @param content the {@link org.ctoolkit.api.agent.model.ChangeItem}
       * @return the request
       */
      public Insert insert(java.lang.String metadataId, org.ctoolkit.api.agent.model.ChangeItem content) throws java.io.IOException {
        Insert result = new Insert(metadataId, content);
        initialize(result);
        return result;
      }

      public class Insert extends AgentRequest<org.ctoolkit.api.agent.model.ChangeItem> {

        private static final String REST_PATH = "change/{metadataId}/item";
         ...
         * @since 1.13
         */
        protected Insert(java.lang.String metadataId, org.ctoolkit.api.agent.model.ChangeItem content) {
          super(Agent.this, "POST", REST_PATH, content, org.ctoolkit.api.agent.model.ChangeItem.class);
          this.metadataId = com.google.api.client.util.Preconditions.checkNotNull(metadataId, "Required parameter metadataId must be specified.");
        }
        ...
        public Insert setMetadataId(java.lang.String metadataId) {
          this.metadataId = metadataId;
          return this;
        }
       ...
       * @return the request
       */
      public Update update(java.lang.String metadataId, java.lang.String id, org.ctoolkit.api.agent.model.ChangeItem content) throws java.io.IOException {
        Update result = new Update(metadataId, id, content);
        initialize(result);
        return result;
      }

      public class Update extends AgentRequest<org.ctoolkit.api.agent.model.ChangeItem> {
         ...
         * @since 1.13
         */
        protected Update(java.lang.String metadataId, java.lang.String id, org.ctoolkit.api.agent.model.ChangeItem content) {
          super(Agent.this, "PUT", REST_PATH, content, org.ctoolkit.api.agent.model.ChangeItem.class);
          this.metadataId = com.google.api.client.util.Preconditions.checkNotNull(metadataId, "Required parameter metadataId must be specified.");
          this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
        }
        ...
        public Update setMetadataId(java.lang.String metadataId) {
          this.metadataId = metadataId;
          return this;
        }
    ...
    public class Job {
       ...
       *
       * @param id
       * @param content the {@link org.ctoolkit.api.agent.model.ChangeJob}
       * @return the request
       */
      public Cancel cancel(java.lang.String id, org.ctoolkit.api.agent.model.ChangeJob content) throws java.io.IOException {
        Cancel result = new Cancel(id, content);
        initialize(result);
        return result;
      }

      public class Cancel extends AgentRequest<org.ctoolkit.api.agent.model.ChangeJob> {

        private static final String REST_PATH = "change/{id}/job";
         ...
         * @since 1.13
         */
        protected Cancel(java.lang.String id, org.ctoolkit.api.agent.model.ChangeJob content) {
          super(Agent.this, "PUT", REST_PATH, content, org.ctoolkit.api.agent.model.ChangeJob.class);
          this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
        }
      ...
      /**
       * Create a request for the method "job.delete".
       *
       * This request holds the parameters needed by the agent server.  After setting any optional
       * parameters, call the {@link Delete#execute()} method to invoke the remote operation.
       *
       ...
       * @return the request
       */
      public Progress progress(java.lang.String id) throws java.io.IOException {
        Progress result = new Progress(id);
        initialize(result);
        return result;
      }

      public class Progress extends AgentRequest<org.ctoolkit.api.agent.model.ChangeJob> {
         ...
         * @since 1.13
         */
        protected Progress(java.lang.String id) {
          super(Agent.this, "GET", REST_PATH, null, org.ctoolkit.api.agent.model.ChangeJob.class);
          this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
        }
        ...
        @Override
        public Progress setAlt(java.lang.String alt) {
          return (Progress) super.setAlt(alt);
        }

        @Override
        public Progress setFields(java.lang.String fields) {
          return (Progress) super.setFields(fields);
        }

        @Override
        public Progress setKey(java.lang.String key) {
          return (Progress) super.setKey(key);
        }

        @Override
        public Progress setOauthToken(java.lang.String oauthToken) {
          return (Progress) super.setOauthToken(oauthToken);
        }

        @Override
        public Progress setPrettyPrint(java.lang.Boolean prettyPrint) {
          return (Progress) super.setPrettyPrint(prettyPrint);
        }

        @Override
        public Progress setQuotaUser(java.lang.String quotaUser) {
          return (Progress) super.setQuotaUser(quotaUser);
        }

        @Override
        public Progress setUserIp(java.lang.String userIp) {
        ...
        public Progress setId(java.lang.String id) {
          this.id = id;
          return this;
        }
       ...
       * @return the request
       */
      public Start start(java.lang.String id, org.ctoolkit.api.agent.model.ChangeJob content) throws java.io.IOException {
        Start result = new Start(id, content);
        initialize(result);
        return result;
      }

      public class Start extends AgentRequest<org.ctoolkit.api.agent.model.ChangeJob> {
         ...
         * @since 1.13
         */
        protected Start(java.lang.String id, org.ctoolkit.api.agent.model.ChangeJob content) {
          super(Agent.this, "POST", REST_PATH, content, org.ctoolkit.api.agent.model.ChangeJob.class);
          this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
        }
        ...
        public Start setId(java.lang.String id) {
          this.id = id;
          return this;
        }
  ...
  public class ExportBatch {
     ...
     * @return the request
     */
    public Update update(java.lang.String id, org.ctoolkit.api.agent.model.ExportBatch content) throws java.io.IOException {
      Update result = new Update(id, content);
      initialize(result);
      return result;
    }
    ...
    public class Update extends AgentRequest<org.ctoolkit.api.agent.model.ExportBatch> {
       ...
       * @since 1.13
       */
      protected Update(java.lang.String id, org.ctoolkit.api.agent.model.ExportBatch content) {
    ...
    public class Item {
       ...
       * @return the request
       */
      public Insert insert(java.lang.String metadataId, org.ctoolkit.api.agent.model.ExportItem content) throws java.io.IOException {
        Insert result = new Insert(metadataId, content);
        initialize(result);
        return result;
      }
      ...
      public class Insert extends AgentRequest<org.ctoolkit.api.agent.model.ExportItem> {
         ...
         * @since 1.13
         */
        protected Insert(java.lang.String metadataId, org.ctoolkit.api.agent.model.ExportItem content) {
       ...
       * @return the request
       */
      public Update update(java.lang.String metadataId, java.lang.String id, org.ctoolkit.api.agent.model.ExportItem content) throws java.io.IOException {
        Update result = new Update(metadataId, id, content);
        initialize(result);
        return result;
      }
      ...
      public class Update extends AgentRequest<org.ctoolkit.api.agent.model.ExportItem> {
         ...
         * @since 1.13
         */
        protected Update(java.lang.String metadataId, java.lang.String id, org.ctoolkit.api.agent.model.ExportItem content) {
    ...
    public class Job {
       ...
       *
       * @param id
       * @param content the {@link org.ctoolkit.api.agent.model.ExportJob}
       * @return the request
       */
      public Cancel cancel(java.lang.String id, org.ctoolkit.api.agent.model.ExportJob content) throws java.io.IOException {
        Cancel result = new Cancel(id, content);
        initialize(result);
        return result;
      }
      ...
      public class Cancel extends AgentRequest<org.ctoolkit.api.agent.model.ExportJob> {
         ...
         * @since 1.13
         */
        protected Cancel(java.lang.String id, org.ctoolkit.api.agent.model.ExportJob content) {
          super(Agent.this, "PUT", REST_PATH, content, org.ctoolkit.api.agent.model.ExportJob.class);
          this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
        }
       ...
       * @return the request
       */
      public Start start(java.lang.String id, org.ctoolkit.api.agent.model.ExportJob content) throws java.io.IOException {
        Start result = new Start(id, content);
        initialize(result);
        return result;
      }
      ...
      public class Start extends AgentRequest<org.ctoolkit.api.agent.model.ExportJob> {
         ...
         * @since 1.13
         */
        protected Start(java.lang.String id, org.ctoolkit.api.agent.model.ExportJob content) {
          super(Agent.this, "POST", REST_PATH, content, org.ctoolkit.api.agent.model.ExportJob.class);
          this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
        }
    ...
    /**
     * An accessor for creating requests from the Migrate collection.
     *
     * <p>The typical use is:</p>
     * <pre>
     *   {@code Agent agent = new Agent(...);}
     *   {@code Agent.Migrate.List request = agent.migrate().list(parameters ...)}
     * </pre>
     *
     * @return the resource collection
     */
    ...
    /**
     * The "migrate" collection of methods.
     */
    public class Migrate {

      /**
       * Create a request for the method "migrate.insert".
       *
       * This request holds the parameters needed by the agent server.  After setting any optional
       * parameters, call the {@link Insert#execute()} method to invoke the remote operation.
       *
       ...
       * @return the request
       */
      public Insert insert(java.lang.String id) throws java.io.IOException {
      ...
      public class Insert extends AgentRequest<org.ctoolkit.api.agent.model.ImportBatch> {
        ...
        private static final String REST_PATH = "export/{id}/migrate";
         ...
         * @since 1.13
         */
        protected Insert(java.lang.String id) {
          super(Agent.this, "POST", REST_PATH, null, org.ctoolkit.api.agent.model.ImportBatch.class);
          this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
        }
  ...
  public class ImportBatch {
     ...
     * @return the request
     */
    public Update update(java.lang.String id, org.ctoolkit.api.agent.model.ImportBatch content) throws java.io.IOException {
      Update result = new Update(id, content);
      initialize(result);
      return result;
    }
    ...
    public class Update extends AgentRequest<org.ctoolkit.api.agent.model.ImportBatch> {
       ...
       * @since 1.13
       */
      protected Update(java.lang.String id, org.ctoolkit.api.agent.model.ImportBatch content) {
    ...
    public class Item {
       ...
       * @return the request
       */
      public Insert insert(java.lang.String metadataId, org.ctoolkit.api.agent.model.ImportItem content) throws java.io.IOException {
        Insert result = new Insert(metadataId, content);
        initialize(result);
        return result;
      }
      ...
      public class Insert extends AgentRequest<org.ctoolkit.api.agent.model.ImportItem> {
         ...
         * @since 1.13
         */
        protected Insert(java.lang.String metadataId, org.ctoolkit.api.agent.model.ImportItem content) {
       ...
       * @return the request
       */
      public Update update(java.lang.String metadataId, java.lang.String id, org.ctoolkit.api.agent.model.ImportItem content) throws java.io.IOException {
        Update result = new Update(metadataId, id, content);
        initialize(result);
        return result;
      }
      ...
      public class Update extends AgentRequest<org.ctoolkit.api.agent.model.ImportItem> {
         ...
         * @since 1.13
         */
        protected Update(java.lang.String metadataId, java.lang.String id, org.ctoolkit.api.agent.model.ImportItem content) {
    ...
    public class Job {
       ...
       *
       * @param id
       * @param content the {@link org.ctoolkit.api.agent.model.ImportJob}
       * @return the request
       */
      public Cancel cancel(java.lang.String id, org.ctoolkit.api.agent.model.ImportJob content) throws java.io.IOException {
        Cancel result = new Cancel(id, content);
        initialize(result);
        return result;
      }
      ...
      public class Cancel extends AgentRequest<org.ctoolkit.api.agent.model.ImportJob> {
         ...
         * @since 1.13
         */
        protected Cancel(java.lang.String id, org.ctoolkit.api.agent.model.ImportJob content) {
          super(Agent.this, "PUT", REST_PATH, content, org.ctoolkit.api.agent.model.ImportJob.class);
          this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
        }
       ...
       * @return the request
       */
      public Start start(java.lang.String id, org.ctoolkit.api.agent.model.ImportJob content) throws java.io.IOException {
        Start result = new Start(id, content);
        initialize(result);
        return result;
      }
      ...
      public class Start extends AgentRequest<org.ctoolkit.api.agent.model.ImportJob> {
         ...
         * @since 1.13
         */
        protected Start(java.lang.String id, org.ctoolkit.api.agent.model.ImportJob content) {
          super(Agent.this, "POST", REST_PATH, content, org.ctoolkit.api.agent.model.ImportJob.class);
          this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
        }
  ...
  public class Metadata {
    ...
    public class Kind {
      ...
      public class Property {
         ...
         * @return the request
         */
        public List list(java.lang.String kind) throws java.io.IOException {
        ...
        public class List extends AgentRequest<org.ctoolkit.api.agent.model.PropertyMetaDataCollection> {
           ...
           * @since 1.13
           */
          protected List(java.lang.String kind) {
