...
public class Agent extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class ExportBatch {
    ...
    public class Item {
       ...
       * @return the request
       */
      public Insert insert(String metadataId, org.ctoolkit.api.agent.model.ExportItem content) throws java.io.IOException {
      ...
      public class Insert extends AgentRequest<org.ctoolkit.api.agent.model.ExportItem> {
         ...
         * @since 1.13
         */
        protected Insert(String metadataId, org.ctoolkit.api.agent.model.ExportItem content) {
        ...
        public Insert setMetadataId(String metadataId) {
          this.metadataId = metadataId;
          return this;
        }
    ...
    public class Job {
       ...
       * @return the request
       */
      public Cancel cancel(Long id, org.ctoolkit.api.agent.model.ExportJob content) throws java.io.IOException {
      ...
      public class Cancel extends AgentRequest<org.ctoolkit.api.agent.model.ExportJob> {
         ...
         * @since 1.13
         */
        protected Cancel(Long id, org.ctoolkit.api.agent.model.ExportJob content) {
       ...
       * @return the request
       */
      public Start start(Long id, org.ctoolkit.api.agent.model.ExportJob content) throws java.io.IOException {
      ...
      public class Start extends AgentRequest<org.ctoolkit.api.agent.model.ExportJob> {
         ...
         * @since 1.13
         */
        protected Start(Long id, org.ctoolkit.api.agent.model.ExportJob content) {
  ...
  public class ImportBatch {
    ...
    public class Item {
       ...
       * @return the request
       */
      public Insert insert(String metadataId, org.ctoolkit.api.agent.model.ImportItem content) throws java.io.IOException {
        Insert result = new Insert(metadataId, content);
        initialize(result);
        return result;
      }
      ...
      public class Insert extends AgentRequest<org.ctoolkit.api.agent.model.ImportItem> {
         ...
         * @since 1.13
         */
        protected Insert(String metadataId, org.ctoolkit.api.agent.model.ImportItem content) {
    ...
    public class Job {
       ...
       * @return the request
       */
      public Cancel cancel(Long id, org.ctoolkit.api.agent.model.ImportJob content) throws java.io.IOException {
        Cancel result = new Cancel(id, content);
        initialize(result);
        return result;
      }
      ...
      public class Cancel extends AgentRequest<org.ctoolkit.api.agent.model.ImportJob> {
         ...
         * @since 1.13
         */
        protected Cancel(Long id, org.ctoolkit.api.agent.model.ImportJob content) {
       ...
       * @return the request
       */
      public Start start(Long id, org.ctoolkit.api.agent.model.ImportJob content) throws java.io.IOException {
        Start result = new Start(id, content);
        initialize(result);
        return result;
      }
      ...
      public class Start extends AgentRequest<org.ctoolkit.api.agent.model.ImportJob> {
         ...
         * @since 1.13
         */
        protected Start(Long id, org.ctoolkit.api.agent.model.ImportJob content) {
