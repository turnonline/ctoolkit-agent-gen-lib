...
/**
 * Model definition for MigrationItem.
 *
...
public final class MigrationItem extends com.google.api.client.json.GenericJson {
   ...
   */
  public MigrationItem setCreateDate(com.google.api.client.util.DateTime createDate) {
   ...
   */
  public MigrationItem setData(String data) {
    this.data = data;
    return this;
  }
   ...
   */
  public MigrationItem setDataLength(Long dataLength) {
   ...
   */
  public MigrationItem setDataType(String dataType) {
   ...
   */
  public MigrationItem setError(String error) {
    this.error = error;
    return this;
  }
   ...
   */
  public MigrationItem setFileName(String fileName) {
   ...
   */
  public MigrationItem setId(Long id) {
    this.id = id;
    return this;
  }
   ...
   */
  public MigrationItem setName(String name) {
    this.name = name;
    return this;
  }
   ...
   */
  public MigrationItem setState(String state) {
    this.state = state;
    return this;
  }
   ...
   */
  public MigrationItem setUpdateDate(com.google.api.client.util.DateTime updateDate) {
    this.updateDate = updateDate;
    return this;
  }

  @Override
  public MigrationItem set(String fieldName, Object value) {
    return (MigrationItem) super.set(fieldName, value);
  }

  @Override
  public MigrationItem clone() {
