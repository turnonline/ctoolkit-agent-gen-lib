...
public final class ImportJob extends com.google.api.client.json.GenericJson {
   ...
   */
  public ImportJob setId(Long id) {
    this.id = id;
    return this;
  }
   ...
   */
  public ImportJob setJobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
   ...
   */
  public ImportJob setJobUrl(String jobUrl) {
    this.jobUrl = jobUrl;
    return this;
  }
   ...
   */
  public ImportJob setProcessedErrorItems(Integer processedErrorItems) {
   ...
   */
  public ImportJob setProcessedItems(Integer processedItems) {
   ...
   */
  public ImportJob setStackTrace(String stackTrace) {
   ...
   */
  public ImportJob setState(String state) {
    this.state = state;
    return this;
  }
   ...
   */
  public ImportJob setTotalItems(Integer totalItems) {
